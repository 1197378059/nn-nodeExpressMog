...
var dbURL = 'mongodb://localhost/hello-world';
...
DB.prototype.getConnection = function (table_name) {
    ...
    if (!client) {
        ...
        this.tabConf = require(modelPath + table_name);
        var nodeSchema = new mongoose.Schema(this.tabConf);
...
DB.prototype.save = function (table_name, fields, callback) {
    var fieldsConfig = require(modelPath + table_name);
    if (!fields) {
